...
namespace Factory
{
    std::vector<FrameBuffer> MakeFrameBuffers(const ElementStorage<Texture, TextureId>& textureStorage)
    {
        ...
        ssaoInputFrameBuffer.AttachTexture(GL_COLOR_ATTACHMENT1, textureStorage.GetElement(TextureId::SsaoLightSpacePosition));
        ssaoInputFrameBuffer.AttachTexture(GL_COLOR_ATTACHMENT2, textureStorage.GetElement(TextureId::SsaoNormal));
        ssaoInputFrameBuffer.AttachTexture(GL_COLOR_ATTACHMENT3, textureStorage.GetElement(TextureId::SsaoAlbedo));
        ssaoInputFrameBuffer.AttachTexture(GL_COLOR_ATTACHMENT4, textureStorage.GetElement(TextureId::SsaoPointLightsContribution));
        ssaoInputFrameBuffer.AttachTexture(GL_COLOR_ATTACHMENT5, textureStorage.GetElement(TextureId::SsaoStencil));
