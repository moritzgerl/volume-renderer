...
namespace Factory
{
    std::vector<Texture> MakeTextures(const SsaoUtils& ssaoUtils)
    {
        ...
        textures.emplace_back(TextureId::SsaoLightSpacePosition, GL_TEXTURE2, Config::windowWidth, Config::windowHeight, GL_RGBA16F, GL_RGBA, GL_FLOAT, GL_NEAREST, GL_CLAMP_TO_EDGE);
