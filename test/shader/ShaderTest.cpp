...
{
    EXPECT_NO_THROW(Shader shader(ShaderId::Volume, ShaderSource::GetShaderSource(ShaderId::Volume, true), ShaderSource::GetShaderSource(ShaderId::Volume, false)));
}

TEST_F(ShaderTest, GetIdReturnsCorrectId)
{
    Shader shader{ShaderId::Volume, ShaderSource::GetShaderSource(ShaderId::Volume, true), ShaderSource::GetShaderSource(ShaderId::Volume, false)};
    EXPECT_EQ(shader.GetId(), ShaderId::Volume);
}

TEST_F(ShaderTest, GetIdReturnsCorrectIdForDifferentShader)
{
    Shader shader{ShaderId::DebugQuad, ShaderSource::GetShaderSource(ShaderId::DebugQuad, true), ShaderSource::GetShaderSource(ShaderId::DebugQuad, false)};
...
{
    Shader shader1{ShaderId::Volume, ShaderSource::GetShaderSource(ShaderId::Volume, true), ShaderSource::GetShaderSource(ShaderId::Volume, false)};
    Shader shader2{ShaderId::DebugQuad, ShaderSource::GetShaderSource(ShaderId::DebugQuad, true), ShaderSource::GetShaderSource(ShaderId::DebugQuad, false)};
