...
{
    EXPECT_NO_THROW(Shader shader(ShaderId::Volume, TestUtils::LoadShaderOrThrow(ShaderId::Volume, ShaderType::Vertex), TestUtils::LoadShaderOrThrow(ShaderId::Volume, ShaderType::Fragment)));
}

TEST_F(ShaderTest, GetIdReturnsCorrectId)
{
    Shader shader{ShaderId::Volume, TestUtils::LoadShaderOrThrow(ShaderId::Volume, ShaderType::Vertex), TestUtils::LoadShaderOrThrow(ShaderId::Volume, ShaderType::Fragment)};
    EXPECT_EQ(shader.GetId(), ShaderId::Volume);
}

TEST_F(ShaderTest, GetIdReturnsCorrectIdForDifferentShader)
{
    Shader shader{ShaderId::DebugQuad, TestUtils::LoadShaderOrThrow(ShaderId::DebugQuad, ShaderType::Vertex), TestUtils::LoadShaderOrThrow(ShaderId::DebugQuad, ShaderType::Fragment)};
...
{
    Shader shader1{ShaderId::Volume, TestUtils::LoadShaderOrThrow(ShaderId::Volume, ShaderType::Vertex), TestUtils::LoadShaderOrThrow(ShaderId::Volume, ShaderType::Fragment)};
    Shader shader2{ShaderId::DebugQuad, TestUtils::LoadShaderOrThrow(ShaderId::DebugQuad, ShaderType::Vertex), TestUtils::LoadShaderOrThrow(ShaderId::DebugQuad, ShaderType::Fragment)};
