...
{
    EXPECT_NO_THROW(Shader shader(ShaderId::Volume, FileSystem::GetPath("src/shaders/Volume.vert").string().c_str(), FileSystem::GetPath("src/shaders/Volume.frag").string().c_str()));
}

TEST_F(ShaderTest, GetIdReturnsCorrectId)
{
    Shader shader{ShaderId::Volume, FileSystem::GetPath("src/shaders/Volume.vert").string().c_str(), FileSystem::GetPath("src/shaders/Volume.frag").string().c_str()};
    EXPECT_EQ(shader.GetId(), ShaderId::Volume);
}

TEST_F(ShaderTest, GetIdReturnsCorrectIdForDifferentShader)
{
    Shader shader{ShaderId::DebugQuad, FileSystem::GetPath("src/shaders/DebugQuad.vert").string().c_str(), FileSystem::GetPath("src/shaders/DebugQuadColor.frag").string().c_str()};
...
{
    Shader shader1{ShaderId::Volume, FileSystem::GetPath("src/shaders/Volume.vert").string().c_str(), FileSystem::GetPath("src/shaders/Volume.frag").string().c_str()};
    Shader shader2{ShaderId::DebugQuad, FileSystem::GetPath("src/shaders/DebugQuad.vert").string().c_str(), FileSystem::GetPath("src/shaders/DebugQuadColor.frag").string().c_str()};
